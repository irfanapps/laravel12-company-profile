@extends('frontend.applications.layouts.app')
@section('content')
    <!-- Start Hero -->
    <!-- Introduction -->
    <div class="pt-4 pb-14 text-center">
        <div class="container px-4 sm:px-8 xl:px-4">
            <p class="mb-4 text-gray-800 text-3xl leading-10 lg:max-w-5xl lg:mx-auto"> Team management mobile apps don’t get
                better than Pavo. It’s probably the best app in the world for this purpose. Don’t hesitate to give it a try
                today and you will fall in love with it</p>
    ...
    <div id="features" class="cards-1">
        <div class="container px-4 sm:px-8 xl:px-4">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="{{ asset('images/features-icon-2.svg') }}" alt="alternative" />
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="{{ asset('images/features-icon-3.svg') }}" alt="alternative" />
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="{{ asset('images/features-icon-4.svg') }}" alt="alternative" />
                </div>
                <div class="card-body">
                    <h5 class="card-title">Multiple Languages</h5>
                    <p class="mb-4">Choose from one of the 40 languages that come pre-installed and start selling smarter
                    </p>
                </div>
            </div>
            <!-- end of card -->
            ...
            <div class="card">
                <div class="card-image">
                    <img src="{{ asset('images/features-icon-5.svg') }}" alt="alternative" />
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="{{ asset('images/features-icon-6.svg') }}" alt="alternative" />
                </div>
                <div class="card-body">
                    <h5 class="card-title">Community Support</h5>
                    <p class="mb-4">Register the app and get acces to knowledge and ideas from the Pavo online community
                    </p>
                </div>
            </div>
            <!-- end of card -->
    ...
    <div id="details" class="pt-12 pb-16 lg:pt-16">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            ...
            <div class="lg:col-span-7">
                <div class="xl:ml-14">
                    <img class="inline" src="{{ asset('images/details-1.jpg') }}" alt="alternative" />
                </div>
            </div> <!-- end of col -->
        </div> <!-- end of container -->
    </div>
        ...
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            <div class="lg:col-span-7">
                <div class="mb-12 lg:mb-0 xl:mr-14">
                    <img class="inline" src="{{ asset('images/details-2.jpg') }}" alt="alternative" />
                </div>
            </div> <!-- end of col -->
            <div class="lg:col-span-5">
                <div class="xl:mt-12">
        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-x-8">
            ...
            <div class="lg:col-span-8">
                <div class="mb-12 text-center lg:mb-0 lg:text-left xl:mr-6">
                    <img class="inline rounded-lg" src="{{ asset('images/details-lightbox.jpg') }}" alt="alternative" />
                </div>
            </div> <!-- end of col -->
    ...
    <div class="pt-16 pb-12">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            ...
            <div class="lg:col-span-7">
                <div class="ml-14">
                    <img class="inline" src="{{ asset('images/details-3.jpg') }}" alt="alternative" />
                </div>
            </div> <!-- end of col -->
        </div> <!-- end of container -->
    </div>
                ...
                <div class="swiper-container card-slider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="{{ asset('images/testimonial-1.jpg') }}"
                                    alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="{{ asset('images/testimonial-2.jpg') }}"
                                    alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="{{ asset('images/testimonial-3.jpg') }}"
                                    alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="{{ asset('images/testimonial-4.jpg') }}"
                                    alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="{{ asset('images/testimonial-5.jpg') }}"
                                    alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="{{ asset('images/testimonial-6.jpg') }}"
                                    alt="alternative" />
                                <div class="card-body">
