                        ...
                        <div class="lg:col-span-4 md:col-span-12">
                            ...
                            <ul class="list-none mt-6">
                                <li class="inline"><a href="https://1.envato.market/techwind" target="_blank"
                                        class="size-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center border border-gray-800 rounded-md hover:border-indigo-600 hover:bg-indigo-600"><i
        ...
        <div class="container relative text-center">
            <div class="grid md:grid-cols-2 items-center">
                ...
                <ul class="list-none md:text-end text-center mt-6 md:mt-0">
                    <li class="inline"><a href=""><img src="{{ asset('images/payments/american-ex.png') }}"
                    ...
                    <li class="inline"><a href=""><img src="{{ asset('images/payments/master-card.png') }}"
